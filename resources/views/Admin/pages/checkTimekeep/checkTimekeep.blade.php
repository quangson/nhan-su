                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-inline" action="{{ route('checkTimekeepPersonnal.show') }}" method="get">
                                <input class="form-control mr-sm-2" type="search" name="search" placeholder="Search" aria-label="Search" value="{{ request()->has('search') ? request()->input('search') : '' }}">
                                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($groups as $group)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="">
                                                <a class="btn btn-primary d-inline-block btn-sm mt-1" href="{{ route('checkTimekeepGroup.show', $group->id) }}">Danh sách chấm công</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
