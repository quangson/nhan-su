<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="brand-link logo-switch" style="display: flex; align-items: center;">
            <img src="/assets/img/Logo.jpeg" alt="AdminLTE" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
              <a href="" class="nav-link">
                  <i class="nav-icon fas fa-th"></i>
                  <p>Chấm công<i class="fas fa-angle-left right"></i></p>
              </a>
              <ul class="nav nav-treeview" style="display: none;">
                  <li class="nav-item">
                      <a href="{{ route('checkTimekeepPersonnal.show') }}" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Danh sách</p>
                      </a>
                  </li>
